...
export default function Account() {
  ...
  const USER_ORDERS_API_URL = "https://deployment-capstone.onrender.com/api/orders/me";
  const USER_API_URL = "https://deployment-capstone.onrender.com/api/users/me";
  const UPDATE_EMAIL_API_URL = "https://deployment-capstone.onrender.com/api/users/me";
