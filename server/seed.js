    ...
    try {
      ...
      const [
        ...
        summer_shoes, summer_shorts, summer_shirts, summer_pants
            ...
            createProduct({ product_name: 'shoes', descriptions: 'casual shoes', price: 20.00, stock_quantity: 12 }),
            createProduct({ product_name: 'shirts', descriptions: 'casual shirt', price: 15.00, stock_quantity: 32 }),
            ...
            createProduct({ product_name: 'winter shoes', descriptions: 'winter shoes', price: 20.00, stock_quantity: 19 }),
            createProduct({ product_name: 'winter shirts', descriptions: 'winter shirt', price: 20.00, stock_quantity: 28 }),
            createProduct({ product_name: 'winter jackets', descriptions: 'winter jacket', price: 20.00, stock_quantity: 22 }),
            createProduct({ product_name: 'winter pants', descriptions: 'winter pants', price: 20.00, stock_quantity: 25 }),
            createProduct({ product_name: 'summer shoes', descriptions: 'summer shoes', price: 20.00, stock_quantity: 12 }),
            createProduct({ product_name: 'summer shorts', descriptions: 'summer shorts', price: 12.00, stock_quantity: 21 }),
            createProduct({ product_name: 'summer shirts', descriptions: 'summer shirts', price: 15.00, stock_quantity: 41 }),
            createProduct({ product_name: 'summer pants', descriptions: 'summer pants', price: 20.00, stock_quantity: 23 })
      ]);
