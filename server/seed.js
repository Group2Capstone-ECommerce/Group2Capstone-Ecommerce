...
// const fake_data = {
    ...
    const[shoes, shirts, shorts, sweaters, pants, socks, jackets, belts, hoodies, winter_shoes, winter_shirts, winter_jackets, winter_pants, summer_shoes, summer_shorts, summer_shirts, summer_pants] = await promise.all([
        createProduct({product_name: 'shoes', descriptions: 'casual shoes', price: '20$', tags: 'casual', image_urls: '', rating: '4/5', stock_quantity: '12'}),
        createProduct({product_name: 'shirts', descriptions: 'casual shirt', price: '15$', tags: 'casual', image_urls: '', rating: '3/5', stock_quantity: '32'}),
        createProduct({product_name: 'shorts', descriptions: 'casual shorts', price: '12$', tags: 'casual', image_urls: '', rating: '4/5', stock_quantity: '56'}),
        createProduct({product_name: 'sweaters', descriptions: 'casual sweater', price: '25$', tags: 'casual', image_urls: '', rating: '3/5', stock_quantity: '23'}),
        createProduct({product_name: 'pants', descriptions: 'casual pants', price: '20$', tags: 'casual', image_urls: '', rating: '2/5', stock_quantity: '61'}),
        createProduct({product_name: 'Socks', descriptions: 'casual socks', price: '10$', tags: 'casual', image_urls: '', rating: '4/5', stock_quantity: '42'}),
        createProduct({product_name: 'jackets', descriptions: 'casual jackets', price: '35$', tags: 'casual', image_urls: '', rating: '4/5', stock_quantity: '13'}),
        createProduct({product_name: 'belts', descriptions: 'casual belts', price: '17$', tags: 'casual', image_urls: '', rating: '4/5', stock_quantity: '29'}),
        createProduct({product_name: 'hoodies', descriptions: 'casual hoodies', price: '30$', tags: 'casual', image_urls: '', rating: '2/5', stock_quantity: '30'}),
        createProduct({product_name: 'winter shoes', descriptions: 'winter shoes', price: '20$', tags: 'winter', image_urls: '', rating: '5/5', stock_quantity: '19'}),
        createProduct({product_name: 'winter shirts', descriptions: 'winter shirt', price: '20$', tags: 'winter', image_urls: '', rating: '3/5', stock_quantity: '28'}),
        createProduct({product_name: 'winter jackets', descriptions: 'winter jacket', price: '20$', tags: 'winter', image_urls: '', rating: '3/5', stock_quantity: '22'}),
        createProduct({product_name: 'winter pants', descriptions: 'winter pants', price: '20$', tags: 'winter', image_urls: '', rating: '4/5', stock_quantity: '25'}),
        createProduct({product_name: 'summer shoes', descriptions: 'summer shoes', price: '20$', tags: 'summer', image_urls: '', rating: '3/5', stock_quantity: '12'}),
        createProduct({product_name: 'summer shorts', descriptions: 'summer shorts', price: '12$', tags: 'summer', image_urls: '', rating: '3/4', stock_quantity: '21'}),
        createProduct({product_name: 'summer shirts', descriptions: 'summer shirts', price: '15$', tags: 'summer', image_urls: '', rating: '5/5', stock_quantity: '41'}),
        createProduct({product_name: 'summer pants', descriptions: 'summer pants', price: '20$', tags: 'summer', image_urls: '', rating: '3/5', stock_quantity: '23'}),
        
    ])
    // Users -
    const [bob, ellie, jack, donna, rick, lisa, denise, oliver, samuel, wendy] = await promise.all([
        createUser({username: 'Bob', email: 'bob@email.com', password_hash: '', is_admin: false, mailing_address: 'bobmailingaddress', phone: '219-555-9235'}),
        createUser({username: 'Ellie', email: 'Ellise@email.com', password_hash: '', is_admin: true, mailing_address: 'elliemailingaddress', phone: '832-555-6172'}),
        createUser({username: 'Jack', email: 'Jack@email.com', password_hash: '', is_admin: false, mailing_address: 'jackmailingaddress', phone: '926-555-0151'}),
        createUser({username: 'Donna', email: 'Donna@email.com', password_hash: '', is_admin: false, mailing_address: 'donnamailingaddress', phone: '162-555-8458'}),
        createUser({username: 'Rick', email: 'Rick@gmail.com', password_hash: '', is_admin: false, mailing_address: 'rickmailingaddress', phone: '293-555-1932'}),
        createUser({username: 'Lisa', email: 'Lisa@email.com', password_hash: '', is_admin: false, mailing_address: 'lisamailingaddress', phone: '816-555-4152'}),
        createUser({username: 'Denise', email: 'Denise@email.com', password_hash: '', is_admin: false, mailing_address: 'denisemailingaddress', phone: '173-555-3047'}),
        createUser({username: 'Oliver', email: 'Oliver@email.com', password_hash: '', is_admin: true, mailing_address: 'olivermailingaddress', phone: '891-555-6327'}),
        createUser({username: 'Samuel', email: 'Samuel@email.com', password_hash: '', is_admin: false, mailing_address: 'samuelmailingaddress', phone: '216-555-1840'}),
        createUser({username: 'Wendy', email: 'Wendy@email.com', password_hash: '', is_admin: false, mailing_address: 'wendymailingaddress', phone: '252-555-1047'}),
